/*!
 * @license
 * TradingView Lightweight Charts™ v4.1.0-dev+202308071428
    ...
    class ChartModel {
        ...
        _internal_updateTimeScale(newBaseIndex, newPoints, firstChangedPointIndex) {
            ...
            if (visibleBars !== null && oldFirstTime !== null && newFirstTime !== null) {
                ...
                let needShiftVisibleRangeOnNewBar = isLastSeriesBarVisible && this._private__timeScale._internal_options().shiftVisibleRangeOnNewBar;
                // console.log(this._private__timeScale._internal_options().shiftVisibleRangeOnNewBar)
                // console.log('isLastSeriesBarVisible', isLastSeriesBarVisible)
                // console.log('needShiftVisibleRangeOnNewBar', needShiftVisibleRangeOnNewBar)

                // needShiftVisibleRangeOnNewBar = true
    ...
    ***************************************************************************** */
    ...
    class DataLayer {
        ...
        _internal_updateSeriesData(series, data) {
            ...
            const dataToPlotRow = series._internal_customSeriesPlotValuesBuilder();
            const customWhitespaceChecker = series._internal_customSeriesWhitespaceCheck();
            const plotRow = createPlotRow(time, pointDataAtTime._internal_index, data, originalTime, dataToPlotRow, customWhitespaceChecker);
    ...
    class SeriesApi {
        constructor(series, dataUpdatesConsumer, priceScaleApiProvider, chartApi) {
    ...
    class TimeScaleApi {
        ...
        timeToNearestCoordinate(time) {
            const timePoint = convertTime(time);
            const timePointIndex = this._private__timeScale._internal_timeToIndex(timePoint, true);
        ...
        options() {
            return Object.assign(Object.assign({}, this._private__timeScale._internal_options()), { barSpacing: this._private__timeScale._internal_barSpacing() });
        }
    ...
    class ChartApi {
        ...
        _private__addSeriesImpl(type, styleDefaults, options = {}, customPaneView) {
            ...
            const res = new SeriesApi(series, this, this, this);
